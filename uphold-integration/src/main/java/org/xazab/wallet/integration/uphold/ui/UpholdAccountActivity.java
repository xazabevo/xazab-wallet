...
package org.xazab.wallet.integration.uphold.ui;
...
import org.xazab.wallet.common.customtabs.CustomTabActivityHelper;
import org.xazab.wallet.common.ui.CurrencyTextView;
import org.xazab.wallet.common.ui.DialogBuilder;
import org.xazab.wallet.integration.uphold.R;
import org.xazab.wallet.integration.uphold.data.UpholdCard;
import org.xazab.wallet.integration.uphold.data.UpholdClient;
import org.xazab.wallet.integration.uphold.data.UpholdConstants;
import org.xazab.wallet.integration.uphold.data.UpholdException;
...
public class UpholdAccountActivity extends InteractionAwareActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.uphold_buy_xazab_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openBuyXazabUrl();
            }
    ...
    private void loadUserBalance() {
        ...
        UpholdClient.getInstance().getXazabBalance(new UpholdClient.Callback<BigDecimal>() {
            @Override
    ...
    private void openBuyXazabUrl() {
        UpholdCard xazabCard = UpholdClient.getInstance().getCurrentXazabCard();
        if (xazabCard != null) {
            final String url = String.format(UpholdConstants.CARD_URL_BASE, xazabCard.getId());
